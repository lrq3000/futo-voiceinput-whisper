...
## NOTE: this repository is deprecated, as FUTO created an official mirror on GitHub since then, you can find the up-to-date repo here: https://github.com/futo-org/voice-input
